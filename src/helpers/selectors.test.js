...
test("getInterviewersForDay return an array containing the correct interviewer objects", () => {
...
test("getInterviewersForDay returns an empty array when the days is not found", () => {
